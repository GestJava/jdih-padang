...
class Role extends \App\Controllers\BaseController
{
	...
	public function __construct() {
		...
		$this->addJs (base_url('themes/modern/builtin/js/role.js'));
	...
	public function ajaxDeleteData() {
		...
		if ($delete_permission) {
			...
			$used = $this->model->checkRoleUsedDefaultPage();
			if ($used) {
				$result = ['status' => 'error', 'message' => 'Role digunakan sebagai halaman default user'];
			} else {
