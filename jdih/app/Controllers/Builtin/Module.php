...
class Module extends \App\Controllers\BaseController
{
	...
	public function __construct()
	{
		...
		$this->addJs(base_url('themes/modern/builtin/js/module.js'));
	}
	...
	public function ajaxDeleteData()
	{
		...
		if ($delete_permission) {
			...
			$used = $this->model->checkModuleUsedDefaultPage();
			if ($used) {
	...
	public function getDataDT()
	{
		...
		if (!$this->hasPermission('read_all')) {
			...
			$response->setJSON([
				...
				'recordsFiltered' => 0,
				'data' => [],
				'error' => 'Anda tidak memiliki permission untuk membaca data module'
			]);
		...
		$files = \list_files(ROOTPATH . '/app/Controllers');
