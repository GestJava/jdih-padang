...
class Database extends \CodeIgniter\Database\Config
{
	...
	public function __construct()
	{
		...
		// Load database configuration dari environment variables
		...
		$this->default['port'] = isset($_ENV['database.default.port']) ? (int) $_ENV['database.default.port'] : $this->default['port'];
