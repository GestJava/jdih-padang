	...
	<div class="card-body">
		...
		<form method="post" action="" class="form-horizontal" enctype="multipart/form-data">
			<div class="tab-content">
				...
				<div class="row mb-3">
					<label class="col-sm-3 col-md-2 col-lg-3 col-xl-2 col-form-label">Instansi</label>
					<div class="col-sm-8 col-md-6 col-lg-4">
						<?php
						$instansi_options = ['' => '-- Pilih Instansi --'];
						if (!empty($list_instansi)) {
							foreach ($list_instansi as $instansi) {
								$instansi_options[$instansi['id']] = $instansi['nama_instansi'];
							}
						}

						$selected_instansi = set_value('id_instansi', @$user_edit['id_instansi']);
						echo options(['name' => 'id_instansi', 'class' => 'select2'], $instansi_options, $selected_instansi);
						?>
						<small class="text-muted">Pilih instansi tempat user bekerja (opsional)</small>
					</div>
				</div>
				<?php
				if (@$user_permission['update_all']) {
