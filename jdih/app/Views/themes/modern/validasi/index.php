<div class="container-fluid">
    ...
    <div class="row mb-4">
        <?php if (!empty($validator_stats)): ?>
            <?php foreach (array_slice($validator_stats, 0, 4) as $stat): ?>
    ...
    <div class="card shadow mb-4">
        <div class="card-header bg-success text-white py-3">
            <h6 class="m-0 font-weight-bold">
                <i class="fas fa-list me-2"></i>Daftar Ajuan Menunggu Validasi
...
<script>
    // DataTable initialization for validasi dashboard
        ...
        if ($.fn.DataTable && $('#data-tables').length) {
            ...
            var table = $('#data-tables').DataTable({
                ...
                language: {
                    ...
                    emptyTable: 'Tidak ada ajuan yang perlu divalidasi saat ini.'
                },
                order: [
                    [4, 'desc']
                ], // Sort by date column
