<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-check-double text-primary me-2"></i><?= esc($title) ?>
        </h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?= base_url('validasi') ?>">Validasi</a></li>
                <li class="breadcrumb-item active" aria-current="page">Proses Validasi</li>
            </ol>
        </nav>
    </div>
        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow mb-4">
                <div class="card-header bg-warning text-dark py-3">
                    <h6 class="m-0 font-weight-bold">
                        <i class="fas fa-tasks me-2"></i>Aksi Validasi
                    </h6>
                </div>
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        <label for="catatan" class="form-label fw-bold">
                            <i class="fas fa-comment me-1"></i>Catatan Validasi
                        </label>
                        <textarea class="form-control" id="catatan" name="catatan" rows="4"
                            placeholder="Berikan catatan jika ada perbaikan atau informasi tambahan yang perlu disampaikan..."></textarea>
                    </div>

                    <div class="mb-4">
                        <label for="dokumen_revisi" class="form-label fw-bold">
                            <i class="fas fa-upload me-1"></i>File Revisi/Validasi (Opsional)
                        </label>
                        <input type="file" class="form-control" id="dokumen_revisi" name="dokumen_revisi" accept=".pdf,.doc,.docx">
                        <div class="form-text">
                            <i class="fas fa-info-circle me-1"></i>
                            Upload file revisi atau catatan validasi jika diperlukan. Format: PDF, DOC, DOCX. Maksimal 5MB.
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" name="aksi" value="lanjutkan" class="btn btn-success btn-lg">
                                <i class="fas fa-check-circle me-2"></i>
                                Lanjutkan ke Finalisasi
                            </button>
                            ...
                            <button type="submit" name="aksi" value="tolak" class="btn btn-danger btn-lg"
                                onclick="return confirm('Apakah Anda yakin ingin menolak ajuan ini?');">
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow">
                <div class="card-header bg-info text-white py-3">
                    <h6 class="m-0 font-weight-bold">
                        <i class="fas fa-lightbulb me-2"></i>Panduan Validasi
                    </h6>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <h6 class="text-info">
                            <i class="fas fa-check-double me-1"></i>Proses Validasi
                        </h6>
                        <p class="small text-muted">
                            Sebagai validator, Anda bertanggung jawab untuk memeriksa substansi hukum dan kesesuaian dengan peraturan yang berlaku.
                        </p>
                    </div>

                    <div class="mb-3">
                        <h6 class="text-success">
                            <i class="fas fa-check-circle me-1"></i>Kriteria Lanjutkan
                        </h6>
                        <ul class="small text-muted">
                            <li>Substansi hukum sudah benar</li>
                            <li>Sesuai dengan peraturan yang berlaku</li>
                            <li>Tidak ada konflik dengan peraturan lain</li>
                        </ul>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <ul class="small text-muted">
                            <li>Ada perbaikan substansi yang diperlukan</li>
                            <li>Dokumen perlu penyempurnaan</li>
                            <li>Ada catatan dari validator</li>
                        </ul>
                    </div>

                    <div class="mb-3">
                        <h6 class="text-danger">
                            <i class="fas fa-times-circle me-1"></i>Kriteria Tolak
                        </h6>
                        <ul class="small text-muted">
                            <li>Bertentangan dengan peraturan yang ada</li>
                            <li>Ada masalah substantif serius</li>
                            <li>Tidak memenuhi syarat hukum</li>
                        </ul>
                    </div>
                    ...
                    <div class="d-grid">
                        <a href="<?= base_url('validasi') ?>" class="btn btn-outline-secondary btn-sm">
