                                    ...
                                    <td>
                                        <?php if (!empty($ajuan['nama_status'])): ?>
                                            <span class="badge bg-info text-white fs-6">
                                                <i class="fas fa-clock me-1"></i><?= esc($ajuan['nama_status']) ?>
                                            </span>
                                        <?php else: ?>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        <label for="catatan" class="form-label fw-bold">
                            <i class="fas fa-comment me-1"></i>Catatan Verifikasi
                        </label>
                    ...
                    <div class="mb-4">
                        <label for="file_koreksi" class="form-label fw-bold">
                            <i class="fas fa-upload me-1"></i>File Catatan (Opsional)
                        </label>
                        <input type="file" class="form-control" id="file_koreksi" name="file_koreksi" accept=".pdf,.doc,.docx">
                        <div class="form-text">
                            <i class="fas fa-info-circle me-1"></i>
                            Upload file catatan tambahan jika diperlukan. Format: PDF, DOC, DOCX. Maksimal 5MB.
                        </div>
                    </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow">
                <div class="card-header bg-info text-white py-3">
                    <h6 class="m-0 font-weight-bold">
                        <i class="fas fa-lightbulb me-2"></i>Panduan Verifikasi
                    </h6>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <h6 class="text-info">
                            <i class="fas fa-search me-1"></i>Proses Verifikasi
                        </h6>
                        <p class="small text-muted">
                            Sebagai verifikator, Anda bertanggung jawab untuk memeriksa kelengkapan dan kebenaran administrasi dokumen yang diajukan.
                        </p>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <ul class="small text-muted">
                            <li>Dokumen lengkap dan sesuai format</li>
                            <li>Informasi administrasi benar</li>
                            <li>Tidak ada kesalahan substantif</li>
                        </ul>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <ul class="small text-muted">
                            ...
                            <li>Ada kesalahan administrasi</li>
                            <li>Format tidak sesuai standar</li>
                        </ul>
                    </div>
                    ...
                    <div class="d-grid">
                        <a href="<?= base_url('verifikasi') ?>" class="btn btn-outline-secondary btn-sm">
