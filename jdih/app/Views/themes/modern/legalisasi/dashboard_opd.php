            ...
            <div class="col-xl-4 col-md-6">
                <div class="glass-card stat-card border-bottom-warning h-100">
                    <div class="card-body p-4">
                        ...
                        <h3 class="stat-value display-5 fw-bold text-dark mb-1"><?= number_format($stats['pending_opd_paraf'] ?? 0) ?></h3>
                        <p class="stat-label text-muted fs-6 mb-4">Menunggu Paraf Anda</p>
                        <div class="stat-progress">
                            <div class="progress" style="height: 6px; border-radius: 4px;">
                                <div class="progress-bar bg-warning" role="progressbar" style="width: 100%; border-radius: 4px;"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="glass-card stat-card border-bottom-dark h-100">
                    <div class="card-body p-4">
                        ...
                        <p class="stat-label text-muted fs-6 mb-4">Riwayat Paraf</p>
                        <div class="stat-progress">
                            <div class="progress" style="height: 6px; border-radius: 4px;">
