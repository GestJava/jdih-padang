<?php /* Standalone view for Dashboard Kepala OPD */ ?>
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">
                <i class="fas fa-building text-primary me-2"></i>Dashboard Kepala OPD
            </h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?= base_url('dashboard') ?>">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="<?= base_url('legalisasi') ?>">Legalisasi</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Kepala OPD</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-primary text-white">
                <h6 class="m-0 font-weight-bold"><i class="fas fa-clock me-2"></i>Dokumen Menunggu Paraf OPD</h6>
            </div>
            <div class="card-body">
                            ...
                            <tbody>
                                <?php foreach ($pending_paraf as $index => $ajuan): ?>
                                    <tr>
                                        ...
                                        <td><span class="badge bg-warning">Menunggu Paraf OPD</span></td>
