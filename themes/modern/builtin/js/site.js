...
const site_light_color = '#4c5152';
const site_dark_color = '#adb5bd';
...
jQuery(document).ready(function () {
	...
	// Toggle sidebar dengan klik (desktop)
	$('.sidebar-guide').on('click', function() {
		$('body').toggleClass('sidebar-hidden');
		// Jika sidebar disembunyikan, pastikan show-sidebar juga dihapus
	...
	$(window).on('resize', function() {
		...
		if (typeof harmonisasiBulanChart !== 'undefined') {
			harmonisasiBulanChart.resize();
		}
		if (typeof harmonisasiStatusChart !== 'undefined') {
			harmonisasiStatusChart.resize();
		}
		if (typeof harmonisasiJenisChart !== 'undefined') {
			harmonisasiJenisChart.resize();
		}
	});
